...
class ProductList extends React.Component {
  ...
  loadData() {
    ...
    document.getElementById("barcodeBtn").style.display = "none"; // document.getElementById("scanner-main").style.display = "block";

    const result = FetchData('/graphql', query).then(result => {
